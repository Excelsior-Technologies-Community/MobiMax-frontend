    ...
    <div className="flex-grow flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 border-t-4 border-t-[#e26a1b]">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Partner Portal</h2>
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 flex flex-col space-y-4">
          <p className="text-center text-sm text-gray-600">
            ...
            <Link to="/partner/signup" className="font-medium text-[#e26a1b] hover:text-[#c45a16] transition-colors">
              Apply now
            </Link>
          </p>
